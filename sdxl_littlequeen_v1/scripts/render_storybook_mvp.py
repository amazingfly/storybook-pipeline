#!/usr/bin/env python3
"""Rank generated story images, narrate scenes, and assemble a local MP4."""
...
GEMMA_ENGINE_VERSION = "storybook-gemma-evidence-v3"
GEMMA_CRITERIA = (
    {
        ...
        "source": "full",
        "question": (
            "Is there exactly one intended Little Queen protagonist? Pass only when "
            "there is one person, one head, and no duplicate, reflected copy, extra "
            "face, or background version of her."
        ),
    },
    {
    ...
    },
    {
        ...
        "source": "full",
        "question": (
            "Are the crown, jewelry, and other visible accessories clean and coherent? "
            "Fail fused crown points, duplicated crowns, jewelry merged into the face "
            "or body, or conspicuously broken accessory geometry."
        ),
    },
    {
    ...
    },
    {
        ...
        "question": (
            ...
            "close to a hand that Gemma independently localized?"
        ),
    },
    {
        ...
        "question": (
            ...
            "head and crown must be visible, with enough body and relevant hands shown "
            "to understand the action. Fail a cropped crown or top of head."
        ),
    },
    {
        "key": "scene_match",
        ...
        "source": "full",
        "question": (
            "Does the candidate visibly show the requested location, major action, and "
            "important story object? Judge concrete scene content, not merely matching "
            "mood, palette, or genre."
        ),
    },
    {
...
Keep each reason factual and criterion-specific, in 14 words or fewer.
        ...
        aggregated[candidate_id] = {
            **{key: value["pass"] for key, value in checks.items()},
            ...
            "notes": (
                "; ".join(failure_notes)
                if failure_notes
                else "Passed all isolated Gemma criteria."
            ),
        }
    return aggregated
...
def judge_scene_multipass(
    ...
    applicable = [
        ...
        if not item.get("requires_accessories")
...
def rank_scene(
    ...
    report_path = scene_dir / "gemma_selection.json"
    ...
    v1_report_path = scene_dir / "gemma_selection_v1.json"
