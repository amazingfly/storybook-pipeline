#!/usr/bin/env python3
"""Bundle the unattended V4 compositor, validator, assets, and run configuration."""
...
OUTPUT = (
    ROOT
    / "storybook_accessories_v4"
    / "colab"
    / "storybook_accessories_v4_auto_bundle.tar.gz"
)
FILES = {
    ...
    ROOT / "storybook_accessories_v4" / "auto_pipeline_config.json": (
